...
def BayesLineFit(x, y, err_x=None, err_y=None, orthfit=True, nwalkers=50, max_iters=10000, outfile_chain="outchain.dat", outfile_bestfit="bestfitvalues.dat", outplot_convergence="convergence", outplot_corner="cornerplot", outplot_bestfit="bestfitplot", slope_bounds=None, int_bounds=None, plotpdf=True, quiet=False):
    '''
